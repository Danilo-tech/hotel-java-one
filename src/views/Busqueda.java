...
private void actualizarHuespedes() {
    ...
    int selectedColumn = tbHuespedes.getSelectedColumn();

    if (selectedRow >= 0 && selectedColumn >= 0) {
        Object value = modeloHuesped.getValueAt(selectedRow, selectedColumn);
        if (value != null) {
            ...
            LocalDate fechaNacimiento = LocalDate.parse(modeloHuesped.getValueAt(selectedRow, 3).toString());
            ...
            Integer idReserva = Integer.valueOf(modeloHuesped.getValueAt(selectedRow, 6).toString());
