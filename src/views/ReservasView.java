...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		separator_1_4.setBounds(68, 454, 289, 2);
		panel.add(separator_1_4);
		
		JLabel lblCheckIn = new JLabel("FECHA DE CHECK IN");
		lblCheckIn.setForeground(SystemColor.textInactiveText);
		lblCheckIn.setBounds(72, 132, 230, 18);
		lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckIn);
		
		JLabel lblCheckOut = new JLabel("FECHA DE CHECK OUT");
		lblCheckOut.setForeground(SystemColor.textInactiveText);
		lblCheckOut.setBounds(72, 221, 230, 18);
		lblCheckOut.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckOut);
		
		JLabel lblFormaPago = new JLabel("FORMA DE PAGO");
		lblFormaPago.setForeground(SystemColor.textInactiveText);
		lblFormaPago.setBounds(72, 382, 187, 24);
		lblFormaPago.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblFormaPago);
		
		JLabel lblTitulo = new JLabel("SISTEMA DE RESERVAS");
		lblTitulo.setHorizontalAlignment(SwingConstants.CENTER);
		lblTitulo.setBounds(85, 63, 243, 42);
		...
		lblValor.setBounds(72, 300, 230, 18);
		lblValor.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblValor);
		
		JSeparator separator_1_3 = new JSeparator();
		separator_1_3.setForeground(SystemColor.textHighlight);
		separator_1_3.setBounds(68, 362, 289, 2);
		...
		txtFechaEntrada.setBounds(69, 161, 289, 35);
		...
		txtFechaSalida.setBounds(69, 246, 289, 35);
		txtFechaSalida.getCalendarButton().setBounds(267, 1, 21, 31);
		txtFechaSalida.setBackground(Color.WHITE);
		txtFechaSalida.setFont(new Font("Roboto", Font.PLAIN, 18));
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				calcularValorEstadia(txtFechaEntrada, txtFechaSalida);
			}
		});
		...
		txtValor.setBounds(78, 327, 70, 35);
		...
		separator_1_1.setBounds(68, 196, 289, 2);
		panel.add(separator_1_1);
		
		JSeparator separator_1_2 = new JSeparator();
		separator_1_2.setForeground(SystemColor.textHighlight);
		separator_1_2.setBackground(SystemColor.textHighlight);
		separator_1_2.setBounds(68, 282, 289, 2);
	...
	public void calcularValorEstadia(JDateChooser fechaEntrada, JDateChooser fechaSalida) {
